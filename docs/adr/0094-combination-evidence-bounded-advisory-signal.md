...
- Phase 7: Surface in existing coaching workflows (explanation strings exist via `explainCombinationEvidence()`; UI surfacing beyond the I-005 insight page is not yet done).
