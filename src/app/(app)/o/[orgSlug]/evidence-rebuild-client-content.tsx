          ...
          {result && (
            <div className="rounded-md border p-4">
              ...
              <dl className="grid grid-cols-2 gap-1 text-sm">
                <dt className="text-[var(--text-muted)]">Matches processed</dt>
