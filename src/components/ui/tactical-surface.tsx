...
const variantClasses: Record<TacticalSurfaceVariant, string> = {
  ...
  hero:
    "bg-[var(--surface-raised)] border border-[var(--border-strong)] shadow-[0_18px_50px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.04)]",
  board:
    "bg-[var(--surface-base)] border border-[var(--border-soft)] shadow-[inset_0_1px_0_rgba(255,255,255,0.02)]",
  subtle:
