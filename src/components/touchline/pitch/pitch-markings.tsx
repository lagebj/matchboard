...
/**
 * Shared pitch markings: subtle-perspective, trapezoid-aware (contract §3/§5 — "Pitch markings
 * must follow the same trapezoid"). Every line/box corner is projected through
 ...
 *
 * Used by both canonical pitch components — `TouchlinePlanningPitch` and (per human review
 * feedback, 2026-09-13) `TouchlinePositionMap`, which previously drew its own flat/no-perspective
 * markings (`FlatPitchMarkings`, removed) but was changed to share this exact same pitch graphic
 * so both renderers present one consistent pitch, differing only in what's placed on top (shirts
 * vs. evidence dots).
 */
