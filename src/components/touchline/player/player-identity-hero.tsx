 ...
 * header, stable across all four tabs — decorative photo replaced by the generated shirt mark
...
export function PlayerIdentityHero({ identity, onBack, onOverflow }: PlayerIdentityHeroProps) {
