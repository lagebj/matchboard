...
**Note:** The primary policy management structure is now policy packs under `policies/packs/`. See `policies/packs/custom-example/` for the recommended pack-based approach.
...
2. Add `policy-pack.json` metadata
...
7. Set `MATCHBOARD_POLICY_PACK_ID=<your-pack-id>` and `MATCHBOARD_POLICY_REGO_ENABLED=true`