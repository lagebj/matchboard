...
// why this budget used to be raised as high as 240s) — the remaining time is genuinely just the
// live-session/WebSocket-connection work this test is actually about.
